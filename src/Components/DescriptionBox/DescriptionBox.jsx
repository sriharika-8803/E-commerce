    ...
    <div className='descriptionbox'>
      ...
      <div className="descriptionbox-description">
        <p>An e-commerce website is an online platform that facilitates the buying and selling of products or services over the internet.
            It serves a virtual marketplace where bussiness and individuals can showcase their products, interact with customers,
        ...
        <p>E-Commerce websites typically display products and services along with detailed descriptions,images,prices and any available 
